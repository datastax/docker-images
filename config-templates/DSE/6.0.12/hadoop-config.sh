...
YARN_DIR=${YARN_DIR:-"lib"}
YARN_LIB_JARS_DIR=${YARN_LIB_JARS_DIR:-"lib"}
MAPRED_DIR=${MAPRED_DIR:-"lib"}
MAPRED_LIB_JARS_DIR=${MAPRED_LIB_JARS_DIR:-"lib"}
...
TOOL_PATH="${TOOL_PATH:-$HADOOP_PREFIX/lib/*}"
